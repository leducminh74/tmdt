                    ...
                    <form method="post" class="login-form" id="change-password-form" action="changepassword">
                        <div class="input-line">
                            <div class="form-group">
                                ...
                                <input type="password" name="Current_password" id="current-password" class="styled-input" placeholder="Mật khẩu hiện tại"/>
                            </div>
                        ...
                        <div class="input-line">
                            <div class="form-group">
                                ...
                                <input type="password" name="New_password" id="new-password" class="styled-input" placeholder="Mật khẩu mới"/>
                            </div>
                            <span class="form-message"></span>
                        </div>
                        <div class="input-line">
                            <div class="form-group">
                                <label ><i class="fas fa-lock"></i></label>
                                <input type="password" name="Renew_password" id="re-newpassword" class="styled-input" placeholder="Nhập lại mật khẩu mới"/>
                            </div>
                            <span class="form-message"></span>
                        </div>

                        <div class="form-group form-button">
                            <input type="submit" name="forgotpass" id="forgotpass" class="form-submit" value="Xác nhận"/>
                        </div>
                    </form>
                </div>
            </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        Validator({
            ...
            rules: [
                Validator.isRequired('#current-password', 'Vui lòng nhập mật khẩu hiện tại'),
                Validator.isRequired('#new-password','Vui lòng nhập mật khẩu mới'),
                Validator.minLength('#new-password',3),
                Validator.isRequired('#re-newpassword','Vui lòng nhập lại mật khẩu mới'),
