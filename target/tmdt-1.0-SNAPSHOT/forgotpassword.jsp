                    ...
                    <form method="post" class="login-form" id="login-form" action="forgotpassword">
                        <div class="input-line">
                            <div class="form-group">
                                ...
                                <input type="text" name="username" id="username" class="styled-input" placeholder="Tài khoản"/>
                            </div>
                        ...
                        <div class="input-line">
                            <div class="form-group">
                                ...
                                <input type="text" name="email" id="email" class="styled-input" placeholder="Email"/>
                            </div>
                            <span class="form-message"></span>
                        </div>

                        <div class="form-group form-button">
                            <input type="submit" name="forgotpass" id="forgotpass" class="form-submit" value="Gửi"/>
                        </div>
                    </form>
                </div>
            </div>
